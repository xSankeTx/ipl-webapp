                  ...
                  <div class="row1">
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="about-title text-center">
						...
						<br>
						<br>
                        <h1 class="heading">Update Player Details</h1>
                  ...
                  <div class="new-details no-padding">
                    ...
                    <div class="row1">
                      ...
                      <div class="col-md-12">
						...
						<input type="name" name="n5"/><br><br>
						<label for="no_matches">Matches Played:</label><br>
						<input type="name" name="n6"/><br><br>
